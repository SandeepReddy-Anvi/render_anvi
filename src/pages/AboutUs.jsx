    ...
    <>
      <main id="about" className="w-full">
        ...
        advantage through breakthrough products, deep-tech systems, and future-proof solutions."
          ...
          buttonLink={mainPagesLinksList.Careers}
          ...
          <div className="max-w-6xl mx-auto grid gap-[90px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[120px] items-center">
              <div>
                ...
                <p className="text-[#0D1F21] text-[18px] font-normal">
                  At Anvi, our vision is to redefine industries through
                  deep-tech innovation. We aim to build robotics and intelligent
                  systems that not only enhance safety and efficiency but also
                  ensure long-term sustainability. By blending advanced
                  technologies with real-world applications, we aspire to shape
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[120px] items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-[#0D1F21] leading-relaxed">
                  ...
                  industries to overcome critical challenges, improve
                  operational efficiency, and deliver measurable impact. Every
                  project we build is focused on creating value for businesses,
                  protecting people, and enabling sustainable growth for future
                  generation.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] md:gap-[120px] items-center">
              <div>
                ...
                <p className="text-[#0D1F21] leading-relaxed">
                  At the heart of Anvi are values that guide everything we do.
                  We believe in Innovation First, always pushing boundaries to
                  deliver new possibilities. Our work is Impact Driven, ensuring
                  real benefits for industries and communities. With Integrity
                  as our foundation, we strive for sustainability in every
                  solution, fostering collaboration and building trust so that
                  industries and societies can thrive together.
                </p>
              </div>
              <div>
                <img
          ...
          <div className="flex-col sm:flex-row justify-center font-dm-sans">
            <div className="flex flex-row gap-6 pl-[33px] max-w-[1161px] flex-wrap">
              ...
              <p className="flex-1 text-[#465455] font-normal leading-[28px] text-[16px]">
                At Anvi, transforming bold ideas into impactful technologies
                that empower industries, inspire communities, and create a
                sustainable future.
              </p>
            </div>
          </div>
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-lg h-[351px]">
                ...
                <div className="absolute inset-0 bg-[#1E1E1EE5] flex flex-col justify-end p-8 text-white">
                  ...
                  <p className="text-sm max-w-[337px] font-urbanist font-light">
                    Every system we design delivers measurable outcomes -
                ...
                <div className="relative flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#7B828E] text-[16px] font-normal mt-1">
                      ...
                      through intelligent systems that enhance safety,
