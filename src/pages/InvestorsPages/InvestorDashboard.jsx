  ...
  return (
    <div className="bg-[#FFFFFF] overflow-hidden min-h-[calc(100vh-101px)]">
      ...
      <div className="relative h-[450px] w-full">
        <img src="/images/investors/hero.png" alt="Our Vision" className="absolute inset-0 w-full h-full object-cover" />
              ...
              <div key={item._id || idx} className="rounded-[24px] border bg-white shadow hover:shadow-lg cursor-pointer transition">
                ...
                <div className="p-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[15px] mt-3 inline-block font-semibold text-[#FA293E]"
                  >
                    Read more →
                  </a>
                </div>
