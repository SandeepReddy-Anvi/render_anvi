  ...
  const featuresData = [
    {
      ...
      theme: "purple",
      description: "We create programs that strengthen environmental health, improve resource efficiency, and support long-term ecological balance in communities.",
      Impact: ["Rural Development", "Urban Renewal", "Community Welfare"],
      Areas: ["Climate & Environmental Programs", "Clean & Sustainable Living Tools"],
    },
    {
      id: "card-1",
      title: "Education & Digital Empowerment",
      theme: "red",
      description: "ANVI develops platforms and initiatives that increase access to knowledge, technology, and learning opportunities for both youth and underserved groups.",
    ...
    },
    {
      ...
      theme: "green",
      description: "We design systems and programs that empower individuals through support networks, resources, and opportunities that help improve quality of life.",
    ...
    },
    {
      ...
      theme: "blue",
      description: "ANVI applies engineering, data, and creative thinking to build solutions that solve real societal challenges and support long-term impact across generations.",
      Impact: ["Government", "SustainSocial Enterprisesability", "Research Institutions"],
  ...
  const whysemiconductorsData = [
    {
      ...
      description: "Every initiative is designed to uplift people and build long-term societal progress with purpose."
    },
    {
      number: "02.",
      title: "Sustainability at the Core",
      description: "Our programs prioritize environmental balance and future-ready development to support sustainable growth."
    },
    {
      number: "03.",
      title: "Community-driven innovation",
      description: "We co-create solutions with communities, not just for them, ensuring every voice truly matters."
    },
    {
      number: "04.",
      title: "Impact that lasts generations",
      description: "Built to strengthen today, empower tomorrow, and inspire the future with meaningful, lasting impact."
    }
  ];
  ...
  <TwoImageSection/>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20  ">
              ...
              <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit space-y-[200px]">
                <h2 className="text-3xl md:text-5xl text-black font-raleway font-medium sm:font-medium sm:text-3xl  mb-8 leading-tight">
                  What ANVI Social<br className="hidden md:block" />Impact Delivers
                </h2>
        ...
        <div>
          <WhySection
            ...
            title={<>Why ANVI <br /> Social Impact</>}
            description={"ANVI Social Impact builds sustainable, human-centered solutions for lasting community progress."}
        ...
        <GradientText
          ...
          ourDescription={["ANVI Social Impact is evolving into a global framework for sustainability, education, and community empowerment.",
