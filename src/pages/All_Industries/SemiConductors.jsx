  ...
  const featuresData = [
    {
      ...
      theme: "blue",
      description:"We engineer advanced semiconductor materials built for durability, thermal stability, and energy efficiency. These materials support the next generation of AI systems, robotics platforms, and high-speed computing devices.",
       marketItems: ["AI Systems", "Robotics", "Edge Computing"],
      serviceItems: ["High-Performance Material Engineering", "Reliability & Stress Testing"],
    ...
    },
    {
      ...
      theme: "purple",
      description:"ANVI develops adaptive semiconductor systems using advanced analytics, AI optimisation, and automated tuning. These technologies anticipate failures, balance workloads, and ensure long-term stability - significantly reducing downtime and operational risk.",
       marketItems: ["Critical Infrastructure", "Data Centers", "Enterprise Systems"],
      serviceItems: ["Semiconductor Performance Analytics", "Adaptive AI-Driven Chip Optimisation"],
    ...
    },
    {
      ...
      theme: "green",
      description:"ANVI designs and develops high-performance semiconductor chips built for speed, efficiency, and precision. Our architectures power intelligent devices, automation platforms, and large-scale computing environments - enabling industries to operate at next-level performance.",
           marketItems: ["Consumer Electronics", "Industrial Automation", "Research Labs"],
      serviceItems: ["Chip Architecture & Design", "High-Performance IC Development"],
    ...
    },
    {
      ...
      theme: "red",
      description:"ANVI builds intelligent embedded semiconductor systems that seamlessly integrate with sensors, devices, and industrial IoT networks. Our micro-systems enable real-time decision-making, automation, and scalable digital transformation.",
       marketItems: ["Smart Devices", "Industrial IoT", "Automation Platforms"],
      serviceItems: ["Embedded System Design", "Sensor Integration & Micro-Architecture"],
  ...
  const whysemiconductorsData = [
    {
      ...
      description: "Our chips and materials are designed using advanced research, world-class engineering, and strict validation standards."
    },
    {
      number: "02.",
      title: "Built for Next-Gen Electronics",
      description: "We engineer semiconductors optimised for AI systems, robotics, automation, IoT, and high-speed industrial electronics."
    },
    {
      number: "03.",
      title: "Scalable, Reliable, Future-Ready",
      description: "Our semiconductor platforms grow with your innovation  from prototypes to full-scale production."
    },
    {
      number: "04.",
      title: "Intelligence at the Core",
      description: "ANVI integrates real-time processing, adaptive optimisation, and AI-driven performance to make every system smarter."
    }
  ];
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20  ">
              ...
              <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit space-y-[200px]">
                <h2 className="text-3xl md:text-5xl text-black font-raleway font-medium sm:font-medium sm:text-3xl  mb-8 leading-tight">
                  What ANVI <br className="hidden md:block" />Semiconductors Delivers
                </h2>
