...
const Careers = () => {
  return (
    <>
      <main id="careers" className="w-full">
        {/* Hero Section */}
        <HeroSection
          ...
          <div className="font-dm-sans font-normal grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-[67.39px]">
            <div>
              ...
              <p className="mt-[11px] text-[16px] text-[#484848]">
                ...
                beyond boundaries, solving real-world challenges across
                industries and communities. At Anvi, you will explore ambitious
                ideas, design scalable systems, and collaborate with bright
                minds. Together, we shape industries of the future while driving
                safety, efficiency, and sustainability for people, businesses,
                and the planet.
              </p>
            </div>
            <div>
              ...
              <p className="mt-[11px] text-[16px] text-[#484848]">
                Explore ambitious ideas, embrace challenges, upskill
                continuously, collaborate with innovators, and build a career
                that grows, evolves, and scales with your limitless potential.
              </p>
            </div>
            <div>
              <img
              ...
              <p className="mt-[11px] text-[16px] text-[#484848]">
                Be part of a culture that values teamwork, inclusion, respect,
                and diverse perspectives, where collaboration, creativity, and
                shared purpose drive excellence and meaningful progress.
              </p>
            </div>
            <div>
              <img
              ...
              <p className="mt-[11px] text-[16px] text-[#484848]">
                Create solutions that drive industry progress, deliver
                measurable impact, and at the same time inspire communities
                while supporting sustainability for a smarter, safer, and better
                shared future.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row px-[160px] py-[70px] gap-[100px]">
            ...
            <div className="bg-[#0A879EE5] text-white px-[40px] py-[80px] rounded-2xl max-w-md">
              ...
              <p className="text-[15px] leading-relaxed">
                Life at Anvi is about more than work — it’s about purpose,
                growth, and collaboration. Here, innovation thrives, ambitious
                ideas take shape, and every individual contributes to meaningful
                impact. With a culture that values teamwork, learning, and
                sustainability, Anvi is where talent transforms into progress
                and the future is engineered together.
              </p>
            </div>
        ...
        <section className="px-4 sm:px-6 md:px-[123px] py-8 sm:py-12 md:py-[80px]">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-[80px] mb-8 sm:mb-10 md:mb-[60px]">
            ...
            <p className="w-full md:w-[520px] text-[18px] leading-[28px] font-dm-sans text-[#484848] font-normal text-center md:text-left">
              Driven by passion and purpose, our people transform bold ideas
              into deep-tech innovations that shape industries and communities.
            </p>
          </div>
