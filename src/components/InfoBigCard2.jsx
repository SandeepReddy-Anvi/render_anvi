...
const InfoCard2 = ({ title, description, Impact, Areas,   theme, id }) => {
  ...
  return (
    ...
    style={{ 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        ...
        {/* Market Column */}
        <div>
          <h4 className="text-gray-400 mb-4 font-medium uppercase tracking-wide text-xs">Impact Sectors</h4>
        ...
        {/* Services Column */}
        <div>
          <h4 className="text-gray-500 mb-4 font-medium uppercase tracking-wide text-xs">Focus Areas</h4>
          <ul className="space-y-3">
