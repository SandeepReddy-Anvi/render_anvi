...
const HeroSection = ({
  ...
  return (
    <section className="w-full h-[calc(100vh-100px)] m-auto overflow-hidden flex justify-start align-top relative">
      ...
      >
        {page === "home" ? (
          <h1 className="text-[36px] md:text-[56px] w-full bg-gradient-to-r from-[#FE7F2C] via-[#FF4A3A] via-[#FA293E] to-[#CD0054] bg-clip-text text-transparent font-[600]" stle={{width: "max-content"}}>
            Engineering Your{" "}
          ...
          <h1 className="text-[36px] w-full lg:w-full lg:text-[56px] bg-gradient-to-r from-[#FE842B] to-[#CD0054] bg-clip-text text-transparent font-[600] leading-tight"
          stle={{width: "max-content"}}>
            {title}
          </h1>
        )}
