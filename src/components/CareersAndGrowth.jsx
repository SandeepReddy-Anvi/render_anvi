          ...
          <div className="lg:col-span-7 z-10">
            ...
            <div className="mt-8">
              <button
                ...
                className=" link-bg-icon1  inline-flex items-center gap-3 bg-white text-black rounded-full px-5 py-3 shadow-md hover:shadow-lg active:scale-95 transition-transform text-sm font-medium"
              >
