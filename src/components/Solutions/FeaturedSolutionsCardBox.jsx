...
const slides = [
  {
    ...
    description: "Autonomous FOD detection, perimeter surveillance & runway maintenance. Revolutionary AI-powered system that transforms airport operations with intelligent automation and real-time monitoring.",
    points: [
  ...
  },
  {
    ...
    description: "An AI-powered sewage cleaning robot that predicts blockages, prevents risks, and cures problems through safe, autonomous operations—ensuring zero manual scavenging",
    points: [
            ...
            <ul className="space-y-3 transition-opacity duration-500 ease-in-out">
              {currentSlide.points.map((point, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-[#353535] font-[400] text-[16px]">{point}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="lg:col-span-6 flex flex-col">
            ...
            <div className="relative overflow-hidden w-full max-w-[567px] aspect-video rounded-2xl shadow-xl transition-all duration-500 ease-in-out">
              <img
                ...
                onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x400/e2e8f0/0f172a?text=Image+Unavailable"; }}
              />
