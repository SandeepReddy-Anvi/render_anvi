        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="w-full lg:w-1/1  grid grid-cols-1 md:grid-cols-2 gap-6 ">
            {cards.map((card, index) => (
              <div
                key={index}
                className="bg-white p-8 md:p-10 rounded-lg hover:bg-gradient-to-r from-[#FE7F2C] via-[#FF4A3A] via-[#FA293E] to-[#CD0054] group cursor-pointer transition-all ease-in-out duration-700"
              >
