...
export const InfoCard = ({
  ...
  return (
    ...
    <div
      id={id}
      className={`w-full p-8 md:p-12  text-white   transition-all duration-500 scroll-mt-32 bg-cover bg-center bg-no-repeat relative overflow-hidden content-end min-h-[750px]`}
      style={{
    ...
    >
      ...
      <div className="mb-12 font-raleway">
        <h2 className="text-4xl md:text-4xl font-semibold font-raleway mb-6">
          {title}
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        ...
        {/* Services Column */}
        <div>
          <h4 className="text-gray-500 mb-4 font-medium uppercase tracking-wide text-xs">
            Services
          </h4>
          <ul className="space-y-3">
