...
export const HomeIndustriesCard = () => {
  ...
  return (
    ...
    <ul className="w-full h-auto flex md:flex-row justify-start 2xl:justify-between gap-[10px] md:gap-[12px] lg:gap-[22px] lg:mx-auto px-0 pt-10 md:pt-16 lg:pt-20 overflow-x-auto overflow-y-hidden scrollbar-hide">
