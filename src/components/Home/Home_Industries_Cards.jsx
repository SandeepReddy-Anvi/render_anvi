...
<ul className="
  w-full h-auto flex flex-row justify-start gap-8 md:gap-10 lg:gap-12 2xl:justify-between 2xl:gap-0 lg:mx-auto px-0 pt-10 md:pt-16 lg:pt-20 overflow-x-auto overflow-y-hidden scrollbar-hide
">
