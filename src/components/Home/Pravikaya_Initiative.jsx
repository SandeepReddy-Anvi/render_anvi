...
export const PravikayaInitiative = () => {
  return (
    <section className="w-full px-5 md:px-[60px] xl:px-[100px] py-[60px] md:py-[100px] overflow-hidden">
      {/* <div className="flex flex-col md:flex-row lg:flex-row gap-10 lg:gap-8 xl:gap-12 2xl:gap-16 items-center max-w-[1600px] mx-auto">
        {/* LEFT – Image collage *
        <div className="flex gap-1 w-auto justify-start flex-shrink-0">
          ...
          <img
            src="/images/home/Pravikya3.png"
            alt="Community Impact"
            className="block lg:hidden w-full md:w-[360px]  md:h-[480px] rounded-[12px] object-cover"
          />
        </div>
        ...
        <div className="w-full lg:flex-1 flex flex-col gap-4 md:items-start">
          ...
          <h3 className="text-[32px] md:text-[38px] lg:text-[44px] 2xl:text-[48px] text-[#100000] font-medium leading-tight">
            <span className="text-[26px] md:text-[28px] lg:text-[30px] 2xl:text-[32px]">
              We help you make
            </span>{" "}
            <br />
          ...
          <p className="text-[16px] md:text-[16px] 2xl:text-[17px] font-medium text-[#100000] leading-relaxed max-w-[600px]">
            ...
            advance industries but also uplift societies, creating a positive
            and lasting impact.
          </p>
      ...
      <div className="flex gap-6">
        ...
        {/* Right Content */}
        <div className="hidden md:block bg-[#F7F4F3] p-[30px] md:p-[53px] rounded-[12px]">

          <div className="flex items-center gap-2">
            <span className="w-6 h-[2px] rounded-full bg-[#CD0054]" />
            <p className="text-[14px] text-[#CD0054] font-bold font-wix tracking-wide uppercase">
              Societal Impact
            </p>
          </div>
      ...
      {/* secound Row - Text, Image*/}
      <div className="flex gap-6 mt-6 items-stretch">
        {/* Left Content */}
        <div className="w-full md:w-[55%] shrink-0 bg-[#F7F4F3] p-[30px] md:p-[53px] rounded-[12px]">
          ...
          <h3 className="md:hidden mb-4 text-[32px] md:text-[38px] lg:text-[44px] 2xl:text-[48px] text-[#100000] font-medium leading-tight">
            <span className="text-[26px] md:text-[28px] lg:text-[30px] 2xl:text-[32px]">
              We help you make
            </span>{" "}
            <br />
          ...
          <p className="text-[16px] md:text-[18px] 2xl:text-[19px] font-semibold mb-4">
            <span className="text-[#100000]">Anvi Social Responsibility</span>{" "}
            <span className="text-[#CD0054]">- Pravikya Initiative</span>
          </p>
          ...
          <Link
            className="md:hidden link-bg-icon1 mt-4 w-[150px] text-[14px] font-semibold flex items-center gap-2"
          >
            <span>Comming Soon</span>
          </Link>
        </div>
        ...
        <div className="w-full">
          <img 
            src="images/home/Pravikya1.jpg"
            alt="Pravikya Initiative"
            className="w-full h-full lg:h-[380px] object-cover object-top rounded-[12px]"
          />
        </div>
      </div>
    </section>
