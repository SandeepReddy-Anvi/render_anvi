import { pagesLinksObj } from "./PagesLinkList";
...
export const IndustriesCardsList = {
    robotics: {
        ...
        link: pagesLinksObj.SemiConductors,
        activeCard: false,
    },lifesciences: {
        ...
        link: pagesLinksObj.LifeSciences,
        activeCard: false,
    },social_impact: {
        imgUrl: '/images/industries/social_impact.jpg',
        title: 'Social Impact',
        desc: 'Empowering people, driving innovation, transforming communities, shaping futures.',
        link: pagesLinksObj.SocialImpact,
        activeCard: false,
    },
};